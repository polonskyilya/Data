...
def fill_anomalies_svd(input_file, voltage_threshold=850, current_threshold=250, temp_threshold=250):
    """
...
if __name__ == "__main__":
    input_file = (r"C:\Users\Ilya Polonsky\PycharmProjects\Data\CSV_DATA_SETS\Prediction_Fault_"
                  r"DataSet\Main_Secondary_DataSet\Filtered\Filtered_Fault_0_WO_Fault_L_main_secondary_Voltage_"
                  r"Current_Temp_Only_dataSet.csv")  # Replace with your input file path
