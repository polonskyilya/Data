...
def process_csv_file(input_file_path):
    ...
    try:
        ...
        # Update measurement names to match actual column names
        measurements = ['Voltage (V)', 'Current (A)', 'Temperature (°C)']
        processed_data = {}
        ...
        for measure in measurements:
            if measure in df.columns:
                ...
                # Use cleaned column names for the new columns
                clean_measure = measure.split(' ')[0].lower()
                processed_data[clean_measure] = (main_values, secondary_values)
        ...
        if valid_rows_idx:
            ...
            for measure in measurements:
                clean_measure = measure.split(' ')[0].lower()
                main_values, secondary_values = processed_data[clean_measure]
                new_df[f'{clean_measure}_main'] = [main_values[i] for i in valid_rows_idx]
                new_df[f'{clean_measure}_secondary'] = [secondary_values[i] for i in valid_rows_idx]
        ...
        output_dir = Path(
            r"C:\Users\polon\PycharmProjects\Data\Prod\CSV_DATA_SETS\Main_Secondary_DataSet")
...
if __name__ == "__main__":
    ...
    input_file = r"C:\Users\polon\PycharmProjects\Data\Prod\CSV_DATA_SETS\Original_Data_Set.prod.csv"
